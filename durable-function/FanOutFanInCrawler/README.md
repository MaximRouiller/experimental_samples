...
Open the solution in Visual Studio 2017 and hit F5.
...
Then you can execute the file with the previously generated GitHub token.

```powershell
.\provision.ps1 -githubToken <TOKEN>
```
